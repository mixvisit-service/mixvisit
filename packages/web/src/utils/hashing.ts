...
const strToBuf = (str: string): Uint8Array => TextEncoder.prototype.encode.bind(new TextEncoder())(str);
...
function x86hash32(
  ...
  if (typeof state === 'number') {
    ...
    const { rem } = (state as x86hash32State);
...
function x64hash128(
  ...
  if (typeof state === 'number') {
    ...
    const { rem } = (state as x64hash128State);
